...
#define LED0_USR_Pin GPIO_PIN_0
#define LED0_USR_GPIO_Port GPIOB
#define LED1_USR_Pin GPIO_PIN_1
#define LED1_USR_GPIO_Port GPIOB
...
#define MOR_R_ENCB_Pin GPIO_PIN_7
#define MOR_R_ENCB_GPIO_Port GPIOB
